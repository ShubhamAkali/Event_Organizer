...
const AboutPage = () => {
  return (
    <div className="bg-blue-100 text-blue-900 min-h-screen flex flex-col">
      <Header />
      <div className="flex-grow p-2 md:p-4 lg:p-8"> {/* Reduced padding */}
        <h1 className="text-2xl md:text-2.5xl lg:text-3xl font-extrabold mb-4 md:mb-5 lg:mb-6 text-center tracking-widest text-blue-800">About Us</h1> {/* Reduced text sizes */}
        <p className="text-lg md:text-xl lg:text-1.5xl font-medium mb-3 md:mb-4 lg:mb-5 leading-relaxed text-justify shadow-lg p-2 md:p-3 bg-blue-200 bg-opacity-75 rounded-lg"> {/* Reduced text sizes */}
        ...
        <h2 className="text-xl md:text-2xl lg:text-2.5xl font-bold mt-5 md:mt-7 lg:mt-8 mb-2 md:mb-3 lg:mb-3 text-center tracking-wide underline text-blue-800">Our Mission</h2> {/* Reduced text sizes */}
        <p className="text-lg md:text-xl lg:text-1.5xl font-medium mb-3 md:mb-4 lg:mb-5 leading-relaxed text-justify shadow-lg p-2 md:p-3 bg-blue-200 bg-opacity-75 rounded-lg"> {/* Reduced text sizes */}
        ...
        <h2 className="text-xl md:text-2xl lg:text-2.5xl font-bold mt-5 md:mt-7 lg:mt-8 mb-2 md:mb-3 lg:mb-3 text-center tracking-wide underline text-blue-800">What We Offer</h2> {/* Reduced text sizes */}
        <ul className="list-disc list-inside text-lg md:text-xl lg:text-1.5xl font-medium mb-3 md:mb-4 lg:mb-5 leading-relaxed text-justify shadow-lg p-2 md:p-3 bg-blue-200 bg-opacity-75 rounded-lg"> {/* Reduced text sizes */}
        ...
        <h2 className="text-xl md:text-2xl lg:text-2.5xl font-bold mt-5 md:mt-7 lg:mt-8 mb-2 md:mb-3 lg:mb-3 text-center tracking-wide underline text-blue-800">Why Choose Us</h2> {/* Reduced text sizes */}
        <p className="text-lg md:text-xl lg:text-1.5xl font-medium mb-3 md:mb-4 lg:mb-5 leading-relaxed text-justify shadow-lg p-2 md:p-3 bg-blue-200 bg-opacity-75 rounded-lg"> {/* Reduced text sizes */}
        ...
        <p className="text-lg md:text-xl lg:text-1.5xl font-medium leading-relaxed text-justify shadow-lg p-2 md:p-3 bg-blue-200 bg-opacity-75 rounded-lg"> {/* Reduced text sizes */}
